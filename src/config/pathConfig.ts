...
export const patheConfigs: PathConfig[] = [
  ...
  },
  {
    ...
    codeUrl: "https://github.com/LQTjim/ubike",
    imgSrc: `${ubikeURL}`,
  ...
  {
    name: "bat-ubike",
    tags: ["typescript", "next", "figma", "vercel", "tailwind"],
    url: "https://bat-frontend-test.vercel.app",
    codeUrl: "https://github.com/LQTjim/bat-frontend-test",
    imgSrc: `${ubikeURL}`,
    description: `用next改寫，還有其他蝙蝠移動的前端試題，詳細在code的README。`,
    shouldDisplay: true,
  },
  {
